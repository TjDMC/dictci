...
<div ng-controller="event_display" ng-init='init(<?=isset($events)?$events:''?>,true)' class="card">
	<div class="card-header">
		<h1>Suspended Work</h1>
	</div>
	<div class="card-body">
		<div class="form-group">
            <button title="Edit Holidays" ng-click="edit=false;showModal(null)" class="btn btn-primary">Add Suspension</button>
        </div>
        ...
        <div class="modal-dialog  modal-dialog-centered modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="eventLabel">{{edit?'Edit':'Add'}} Suspension</h5>
