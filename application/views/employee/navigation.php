		...
		<div class="row" style="width:100%">
			...
			<div class="col-sm-5">
				<div style="float:right">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<span id="left" style="font-size: +35px" data-ng-click="prev()"><i class="fas fa-caret-left"></i></span>
					<select name="lim" ng-model="limit" ng-change="reBegin()">
						<option ng-value="1">1</option>
						<option ng-value="2">2</option>
						<option ng-value="3">3</option>
					</select>
					<span id="right" style="font-size: +35px" data-ng-click="next()"><i class="fas fa-caret-right"></i></span>
				</div>
			</div>
		</div>
