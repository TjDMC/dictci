        ...
        <div ng-init='employeeArray =employeesToArray(<?=$employees?>)'>
    		<div class="row justify-content-between">
    			...
    			<div class="col row align-items-center justify-content-center container">
                    <span class="col text-lg-right text-sm-center" style="min-width:219px">Showing {{(page-1)*limit+1}} to {{(page-1)*limit+getDisplayNumber()}} of {{filteredEmployees.length}} results</span>
