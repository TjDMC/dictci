        ...
        <div ng-init='employeeArray =employeesToArray(<?=$employees?>)'>
    		<div class="row justify-content-between">
    			...
    			<div class="col row align-items-center justify-content-center container">
                    <span class="col text-right" style="min-width:220px">Showing {{(page-1)*limit+1}} to {{(page-1)*limit+getDisplayNumber()}} of {{filteredEmployees.length}} results</span>
                    ...
                    <span class="col align-items-center text-left" style="min-width:232px">
