    ...
    <div class="card-body">
        <div class="alert alert-dark">
            ...
            <div class="text-right">
                <button class="btn btn-primary" data-toggle="modal" data-target="#editEmployeeModal">Edit Employee Info</button>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form ng-submit="add()">
                        ...
                        <div class="dropdown form-group" ng-init="employee.first_day_employ = moment(employee.first_day_employ)">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" min=0 ng-model="employee.vac_leave_bal">
                        </div>
                        <div class="form-group">
                            <label>Initial Sick Leave Credit Balance: </label>
                            <input class="form-control" type="number" min=0 ng-model="employee.sick_leave_bal">
                        </div>
                        <div class="form-group">
                            <label>Highest Salary: </label>
                            <input class="form-control" type="number" min=0 ng-model="employee.highest_salary">
                        </div>
                        <div class="dropdown form-group" ng-init="employee.first_day_compute = moment(employee.first_day_compute)">
                        ...
                        <div class="text-center">
                            ...
                            <button ng-disabled="busy" class="btn btn-danger" type="button">Delete Employee Records</button>
                        </div>
                    </form>
                </div>
